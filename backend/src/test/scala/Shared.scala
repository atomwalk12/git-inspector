...
val storeName_code = "github.com[slash]rfvasile[slash]PPS-22-git-insp-code"
val storeName_text = "github.com[slash]rfvasile[slash]PPS-22-git-insp-text"
val repoName       = "https://github.com/rfvasile/PPS-22-git-insp"
